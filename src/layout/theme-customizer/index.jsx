...
import { ModalTitle, CopyText, Cancel, LayoutType, LTR, RTL, Box, SidebarType, SidebarSettings, Default, Border, IconColor, MixLayout, UnlimitedColor, Apply } from '../../constant'
import {
    ADD_LAYOUT,
    ADD_SIDEBAR_TYPES,
            ...
            <div className="customizer-contain">
                <div className="tab-content" id="c-pills-tabContent">
                    <div className="customizer-header">
                        ...
                        {/* <p className="mb-0">{""} <i className="fa fa-thumbs-o-up txt-primary"></i></p>
