...
import { Password,SignIn, EmailAddress,RememberPassword,ForgotPassword, CreateAccount,LoginWithJWT } from '../../constant';
...
const Login = (props)  => {
    ...
    const [selected] = useState("firebase");
                    ...
                    <TabContent activeTab={selected} className="content-login">
                      <TabPane  className="fade show" tabId={selected === "firebase" ? "firebase" : "jwt"}>
                        <Form className="theme-form">
                          ...
                          <p className="mt-4 mb-0">{"Don't have account?"}<a className="ms-2" href="/register">{CreateAccount}</a></p>
                        </Form>
                      </TabPane>
                </TabContent>
                </div>
