...
// Forms
import FormValidation from '../components/forms/form-control/leave-application'
import BaseInput from '../components/forms/form-control/changeManagement'
import ProjectOnBoardingForm from '../components/forms/form-control/ProjectOnboarding'
import MegaOption from '../components/forms/form-control/Time-Tracker'
import CheckboxandRadio from '../components/forms/form-control/Appraisal'
...
// Tabels
import BasicTabels from '../components/tables/changemanagementreport'
import BorderTable from '../components/tables/projectonboardingreport'
import SizingTable from '../components/tables/timetrackerreport'
import StylingTable from '../components/tables/appraisalreport'
import DataTable from '../components/tables/leavedatareport'
...
// import KanbanData from '../components/application/kanban-board/kanbanlistdata'
...
export const routes = [
        ...
        { path: `${process.env.PUBLIC_URL}/forms/inputGroup/:layout`, Component: <ProjectOnBoardingForm /> },
        ...
        // { path: `${process.env.PUBLIC_URL}/app/kanban-board/:layout`, Component: <KanbanData /> },
